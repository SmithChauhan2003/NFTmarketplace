  ...
  return (
    <div className={styles.chat}>
      ...
      <div className={styles.bottom}>
        <div className={styles.icons}>
          <label htmlFor="file">
            <Image src={images.img} alt="" height={22} width={22} />
          </label>
          <input
            type="file"
            id="file"
            ...
            onChange={handleImg}
          />
          <Image src={images.camera} alt="" height={20} width={20} />
          <Image src={images.mic} alt="" height={20} width={20} />
        </div>
        <input
